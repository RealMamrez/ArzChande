  ...
  return (
    <div className="min-h-screen bg-[#121212] py-12 px-6">
      <div className="container mx-auto max-w-[1400px]">
        <h1 className="text-5xl font-bold text-white mb-12 text-center">ArzChande?</h1>
        ...
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-white mb-6">About ArzChande?</h2>
        ...
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-white mb-6">Source Code</h2>
          <p className="text-gray-300 leading-relaxed text-lg">
        ...
        <section>
          <h2 className="text-4xl font-bold text-white mb-6">Donate</h2>
          <p className="text-gray-300 leading-relaxed text-lg">
