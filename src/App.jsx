  ...
  return (
    <div className="min-h-screen bg-[#121212] py-8 px-4">
      <div className="container mx-auto">
        <h1 className="text-4xl font-bold text-white mb-8 text-center">ArzChande?</h1>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">About ArzChande?</h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">Source Code</h2>
          <p className="text-gray-300 leading-relaxed">
