    ...
    >
      <div className={`relative flex items-center transition-all duration-300 ${isFocused ? 'scale-105' : ''}`}>
        ...
        <input
          ...
          className="w-full bg-[#1c1c1c] text-white pr-12 pl-12 py-4 rounded-2xl outline-none transition-all duration-300 placeholder-gray-500
        ...
        <AnimatePresence>
          {searchTerm && (
            <motion.button
              ...
              className="absolute left-4 text-gray-400 hover:text-gray-300 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
